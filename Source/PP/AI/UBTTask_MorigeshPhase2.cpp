...
#include "UBTTask_MorigeshPhase2.h"
#include "../Character/Player/PlayerCharacter.h"
#include "../Character/Monster/Morigesh.h"
#include "../Character/Monster/MorigeshAlController.h"
UUBTTask_MorigeshPhase2::UUBTTask_MorigeshPhase2(){
	NodeName = TEXT("MorigeshPhase2");
	bNotifyTick = true;
}

EBTNodeResult::Type UUBTTask_MorigeshPhase2::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	if (Monster->GetShieldOn() && Monster->GetShield() == nullptr)
	{
		Monster->SetAttackType(3);
	}
...
EBTNodeResult::Type UUBTTask_MorigeshPhase2::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UUBTTask_MorigeshPhase2::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
